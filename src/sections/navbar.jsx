  ...
  return (
    <nav className="navbar">
      ...
      <ul className={`navbar-nav ${mobileMenu ? "active" : ""}`}>
        ...
        <li><Link to='features' smooth={true} offset={0} duration={500} onClick={toggleMenu}><FaStar style={{ marginRight: '6px' }} />Features</Link></li>
        <li><Link to='skills' smooth={true} offset={0} duration={500} onClick={toggleMenu}><FaTools style={{ marginRight: '6px' }} />Skills</Link></li>
